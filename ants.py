...
class Place(object):
    ...
    def __init__(self, name, exit=None):
        ...
        # BEGIN Problem 2
        "*** YOUR CODE HERE ***"
        # exit can be None or a place
        # if current place has a place as an exit
        # then the exit's entrance is the current place
        if self.exit != None:
            exit.entrance = self
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                # if ant in current place can contain the insect then contain insect
                # if insect can contain the ant in current place then contain ant
                # set ant in current place to be container insect
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            # don't remove if it's the true first queen
            if isinstance(insect, QueenAnt) and insect.name == 'True Queen':
                return 
            # END Problem 13
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        # return False if either there is no Ant in the Bee's place or 
        # if ant's blocks_path attribute is False
        # otherwise, there is an ant that is blocking so return True
    ...
    def action(self, colony):
        ...
        # BEGIN EC
        "*** YOUR CODE HERE ***"
        # bee can go backwards only if it hasn't been scared before and is going backwards
        # change destination to self.place.entrance to go backwards
        if self.scared == False and self.backwards:
...
class HarvesterAnt(Ant):
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 1
        "*** YOUR CODE HERE ***"
        # HarvesterAnt costs 2 food to place but produces 1 food
        colony.food += 1
        # END Problem 1
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        # Next place = current place's entrance
        # For each place, return a random bee if there is any
        # otherwise, return None if there's no bee
        current_place = self.place
        count = 0 # used to compare if current place is within range
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        # when fireant's armor <= 0, all bees in its current place will receive damage
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        # BEGIN Problem 6
        "*** YOUR CODE HERE ***"
        # eat bee by reducing bee's armor to zero
    ...
    def action(self, colony):
        # BEGIN Problem 6
        "*** YOUR CODE HERE ***"
        # if it's digesting decrement its digesting counter
        # Otherwise, eat a random Bee in its place and restart the digesting timer
        if self.digesting > 0:
            self.digesting -= 1
        else:
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 7
        "*** YOUR CODE HERE ***"
        # damage all Bees that fly past, reduce the armor of all Bees in the same place 
        # iterate over a list of bees 
        bee_list = list(self.place.bees)
        for bee in bee_list:
            Insect.reduce_armor(bee, self.damage)
...
# The WallAnt class
class WallAnt(Ant):
    """WallAnt does nothing each turn but has a larger armor value"""
    name = 'Wall'
    food_cost = 4
    implemented = True
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        # return true if bodyguard ant is not containing another ant and
        # if the other ant is not a container
    ...
    def action(self, colony):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        # if bodyguard ant contains an ant, perform that ant's action
...
class TankAnt(BodyguardAnt):
    ...
    def action(self, colony):
        # BEGIN Problem 10
        "*** YOUR CODE HERE ***"
        # protects an ant in its place and also deals 1 damage to all bees in its place
        if self.contained_ant != None:
            self.contained_ant.action(colony)
        bee_list = list(self.place.bees)
        for bee in bee_list:
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        # BEGIN Problem 11
        "*** YOUR CODE HERE ***"
        # add regardless if insect is watersafe
        # if insect is not watersafe, reduce insect's armor to 0
...
class ScubaThrower(ThrowerAnt):
    """A ThrowerAnt that can attack in water."""
    name = 'Scuba'
    food_cost = 6
    is_watersafe = True
    implemented = True
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        "*** YOUR CODE HERE ***"
        self.armor = armor
        if QueenAnt.initialized == False:
            QueenAnt.initialized = True
            self.name = 'True Queen'
        # END Problem 13
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        # helper function for buffing ants only if not buffed already
        def buff_ant(ant):
            if ant not in self.buffed_ants:
                ant.damage *= 2
                self.buffed_ants.append(ant)
        # if it's an imposter reduce its armor to 0
        # otherwise queen attacks and buffs all ants behind the queen
        if self.name != 'True Queen':
            ...
            while current_place:
                if current_place.ant:
                    # if container ant contains an ant, buff both of them
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        self.armor -= amount
        if self.name == 'True Queen' and self.armor <= 0:
            bees_win()
        # END Problem 13
...
def make_slow(action, bee):
    ...
    # BEGIN Problem EC
    "*** YOUR CODE HERE ***"
    # returns a new action that performs the original action when colony.time is even 
    # action is bee.action
...
def make_scare(action, bee):
    ...
    # BEGIN Problem EC
    "*** YOUR CODE HERE ***"
    # return new action method that makes the bee go backwards
    def new_action(colony):
        # add backwards attribute to check in Bee action method
        bee.backwards = True
        action(colony)
    return new_action
    # END Problem EC
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    "*** YOUR CODE HERE ***"
    # effect is make_scare or make_slow
    new_action = effect(bee.action, bee)
    old_action = bee.action
    # effect_helper determines which action to take
    # temporary action method for bee until duration is over
    def effect_helper(colony):
        ...
        if duration > 0:
            ...
            # don't assign old_action to bee.action, just execute it
            # if it is assigned the long effect stacks don't work
            # only reassign scared and backwards if bee was scared
